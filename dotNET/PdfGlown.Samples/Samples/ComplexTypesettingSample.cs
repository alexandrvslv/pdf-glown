...
using PdfGlown.Documents.Contents;
using PdfGlown.Documents.Contents.Composition;
using PdfGlown.Documents.Contents.XObjects;
using PdfGlown.Documents.Interaction.Navigation;
using PdfGlown.Documents.Interaction.Viewer;
using SkiaSharp;
using System;
using System.Collections.Generic;
using System.IO;
using PdfGlown.Documents.Interaction.Actions;
using PdfGlown.Documents.Contents.ColorSpaces;
using PdfGlown.Documents.Contents.Entities;
using PdfGlown.Documents.Contents.Fonts;

namespace PdfGlown.Samples.CLI
{
    ...
    ///   that exploits the new typographic primitives defined in PDF Glown (see BlockComposer
    ///   class in use); this is just a humble experiment -- anybody could develop a typesetter
    ///   sitting upon PDF Glown!</para>
    ///   <para>Anyway, PDF Glown currently lacks support for content flow composition (i.e. paragraphs
    ...
    public class ComplexTypesettingSample : Sample
    {
        ...
        private void BuildBookmarks(PdfDocument document)
        {
            ...
            bookmarks.Add(bookmark = new Bookmark(document, "PDF Glown Home Page",
        ...
        private void BuildWelcomePage(PdfDocument document, FormXObject template)
        {
            ...
            */
            ...
            // Instantiate a jpeg image object!
            var image = Image.Get(GetResourcePath("images" + Path.DirectorySeparatorChar + "Glown.jpg")); // Abstract image (entity).
            ...
            blockComposer.Begin(frame, XAlignmentEnum.Left, YAlignmentEnum.Middle);
            {
                ...
                blockComposer.ShowText("This is a sample document that merely demonstrates some basic graphics features supported by PDF Glown.");
            ...
            blockComposer.Begin(frame, XAlignmentEnum.Justify, YAlignmentEnum.Bottom);
            {
                ...
                blockComposer.ShowText("PS: As promised, since version 0.0.3 PDF Glown has supported");
                // Begin local state!
                /*
        ...
        private FormXObject BuildTemplate(PdfDocument document, DateTime creationDate)
        {
            ...
            // Showing the 'PdfGlown' label inside the common content stream...
            composer.BeginLocalState();
            ...
            // Show the text!
            composer.ShowText("PdfGlown", new SKPoint(0, templateSize.Height - (float)composer.State.Font.GetAscent(composer.State.FontSize)));
            ...
            composer.BeginLocalState();
            {
                ...
                composer.BeginLocalState();
                {
                    ...
                    {
                        blockComposer.ShowText("Generated by PDF Glown on " + creationDate);
